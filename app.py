...
def render_results():
    ...
    if temp_units == "F":
        ...
        get_weather_results_metric(zip_code, api_key)
    ...
    return render_template('results.html',
                           location=location, temp=temp, temp_units=temp_units, dt_obj=dt_obj, sunrise=sunrise,
                           feels_like=feels_like, weather=weather, iconurl=iconurl, now=now
                            )
